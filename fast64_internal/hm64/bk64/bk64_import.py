...
from ...f3d.f3d_material import createF3DMat, update_tex_values_manual
...
def _load_textures(folder: str, base: str, blob: bytes, palettes, used):
    ...
    while True:
        ...
        image.pixels = _decode(data[0x50 : 0x50 + size], otex_format, width, height, palette)
        image.pack()
...
def _build_materials(mesh_obj, base: str, geometry, surfaces, images, animated=None):
    ...
    for key in sorted(keys, key=repr):
        ...
        # and gives up during an import, leaving tile sizes at 1x1
