...
def register_game_presets(game_key, presets_dict):
    _extra_game_presets[game_key] = presets_dict
    material_presets[game_key] = presets_dict


def unregister_game_presets(game_key):
    _extra_game_presets.pop(game_key, None)
    material_presets.pop(game_key, None)
